...
/// A Style used to customize a [AppRadio]
///
...
class AppRadio<T> extends StatelessWidget {
  ...
  AppRadio({
    this.child,
    this.style = const AppRadioStyle(),
    this.value,
  ...
  Widget build(BuildContext context) {
    ...
    return NeumorphicButton(
      ...
      style: NeumorphicStyle(
        ...
        shadowLightColor:
            Provider.of<AppStateNotifier>(context, listen: false).isDarkMode ? DarkColorShadowLight.withOpacity(0.9) : Colors.white.withOpacity(0.7),
        shadowDarkColorEmboss:
            Provider.of<AppStateNotifier>(context, listen: false).isDarkMode ? Colors.black.withOpacity(1) : Colors.grey.withOpacity(0.7),
        shadowLightColorEmboss:
            Provider.of<AppStateNotifier>(context, listen: false).isDarkMode ? Colors.grey.withOpacity(1) : Colors.white.withOpacity(0.7),
