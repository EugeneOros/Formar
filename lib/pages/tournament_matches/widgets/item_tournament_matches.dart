...
class ItemTournamentMatches extends StatefulWidget {
  ...
  const ItemTournamentMatches({Key? key, this.drawDivider = false, required this.match, required this.onOkSetCallback}) : super(key: key);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isSetsHaveScore()
            ? (Provider.of<AppStateNotifier>(context, listen: false).isDarkMode ? DarkColor : Theme.of(context).primaryColorLight.withOpacity(0.5))
