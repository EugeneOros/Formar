  ...
  Widget build(BuildContext context) {
    _getTheme({bool isDark = false}) {
      return ThemeData(
        ...
        textTheme: TextTheme(
          headline1: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 21, fontWeight: FontWeight.bold, color: isDark ? LightBlue : Colors.black),
          // headline1: TextStyle(fontSize: 21, fontWeight: FontWeight.bold, color: isDark ? LightBlue : Colors.black),
          headline2: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 17, fontWeight: FontWeight.w500, color: isDark ? LightBlue : Colors.black),
          // bodyText1: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: isDark ? LightBlue : Colors.black),
          bodyText1: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 17, fontWeight: FontWeight.w300, color: isDark ? LightBlue : Colors.black),
          // bodyText2: TextStyle(fontSize: 14, fontWeight: FontWeight.w300),
          bodyText2: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 14, fontWeight: FontWeight.w200),
          // subtitle1: TextStyle(fontSize: 12, color: isDark ? LightBlue : Colors.grey),
          subtitle1: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 13, fontWeight: FontWeight.w500, color: isDark ? LightBlue : Colors.grey),
          // subtitle2: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: isDark ? Colors.white : Colors.black),
          subtitle2: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 11, fontWeight: FontWeight.w500, color: isDark ? Colors.white : Colors.black),
          // button: TextStyle(fontSize: 15, fontWeight: FontWeight.w300, color: Color(0xffdda9c4)),
          button: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 15, fontWeight: FontWeight.w500, color: Color(0xffdda9c4)),
          // caption: TextStyle(fontSize: 12, fontWeight: FontWeight.w300, color: Colors.black),
          caption: TextStyle(fontFamily: 'TenorSans-Regular', fontSize: 15, fontWeight: FontWeight.w400, color: Colors.black),
        ),
      );
    }
